...
> **仅供参考，不构成任何操作依据**；市场有风险，投资需谨慎，据此操作风险自担。
> 本工具**不持有证券投资咨询牌照**，所有分析仅供学习研究参考，不构成买卖建议。
...
| 检查项 | 内容 |
|--------|------|
| **FINANCE** | 违规金融用语（荐股类、收益保证类、需资质类） |
| **DISCLAIMER** | 是否在显眼位置有免责声明（投资/法律类） |
| **EXAGGERATION** | 绝对化用语（广告法禁止的夸大表述）、夸大描述 |
| 检查项 | 内容 | 依据类型 |
|--------|------|----------|
| **FINANCE** | 违规金融用语（荐股类、收益保证类、需资质类） | 法律 |
| **DISCLAIMER** | 投资/法律免责声明是否在显眼位置 | 法律/法规 |
| **EXAGGERATION** | 绝对化用语（广告法禁止的夸大表述）、夸大描述 | 法律 |
